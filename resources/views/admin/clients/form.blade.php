        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="form-col">
                        <input type="file" name="photo" id="photo" class="form-control form-control-sm" value="{{ isset($method) ? $client->photo : old('photo')}}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="form-col">
                        ...
                        <input type="email" name="email" id="email" class="form-control form-control-sm @error('name') is-invalid @enderror" value="{{ isset($method) ? $client->email : old('email')}}">
                    </div>
                    @error('email')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                ...
                <div class="form-group row">
                    ...
                    <div class="form-col">
                        <input type="number" name="local_phone" id="local_phone" class="form-control form-control-sm" value="{{ isset($method) ? $client->local_phone : old('local_phone')}}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="form-col">
                        <input type="number" name="mobile_phone" id="mobile_phone" class="form-control form-control-sm @error('name') is-invalid @enderror" value="{{ isset($method) ? $client->mobile_phone : old('mobile_phone')}}">
                    </div>
                    @error('mobile_phone')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                ...
                <div class="form-group row">
                    ...
                    <div class="form-col">
                        <input type="date" name="birth_date" id="birth_date" class="form-control form-control-sm @error('name') is-invalid @enderror" value="{{ isset($method) ? $client->birth_date : old('birth_date')}}">
                    </div>
                    @error('birth_date')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
