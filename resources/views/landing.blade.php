...
<head>
    <meta charset="utf-8">
    <title>R.O.W Barbershop</title>
    <base href="/">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="icon" type="image/x-icon" href="img\ROW_BARBERSHOP_LOGO_TRASPARENT.png">
    <!-- <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css" integrity="sha384-9aIt2nRpC12Uk9gS9baDl411NQApFmC26EwAOH8WgZl5MYYxFfc+NcPb1dKGj7Sk" crossorigin="anonymous"> -->
    <!-- Google Fonts css-->
    <link href="https://fonts.googleapis.com/css?family=Josefin+Sans:400,600,700%7CMontserrat:400,500,600,700,800,900"
        rel="stylesheet">
    <!-- Bootstrap css -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="header-banner">
                        <img src="img\ROW_BARBERSHOP_LOGO_TRASPARENT_invert.png" alt="Logo" width="256" />
                        <p>Descubre tu estilo</p>
                        <h3>Tu nuevo y perfecto <br />Estilo & Diseño</h3>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="about-desc">
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has
                            ...
                            versions of Lorem Ipsum.Why do we use it.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row no-pad">
                <div class="col-md-4">
                    <div class="contact-form">
                        <h2 class="contact-form-title">Reserva ahora</h2>
                ...
                <div class="col-md-8">
                    <div class="google-map">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d422.1935233461561!2d-89.67475150473058!3d20.980352903825143!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f567329842496e9%3A0xf638a2ab629d1db!2sR.O.W%20Barber%E2%80%A2Shop!5e0!3m2!1sen!2smx!4v1595491193055!5m2!1sen!2smx"
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="footer-social">
                        <a href="https://www.facebook.com/R.O.W.BarberShop/">Facebook</a>
                        <a href="#">Twitter</a>
                        <a href="#">Instagram</a>
                        <a href="#">Pinterest</a>
                        <a href="#">Googleplus</a>
